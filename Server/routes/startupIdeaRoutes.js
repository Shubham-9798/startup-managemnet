...
module.exports = function(app) {
  ...
  //   app.post("/insertIdea", multer.upload.single('avatar'), jwtUtility.authenticateAccessToken, StartupController.insertIdea)
    ...
    app.post("/addIdeaToUserArray", jwtUtility.authenticateAccessToken, multer.upload.single('file'), StartupController.addIdeaToUserArray)

    // this is admin controller
    app.get("/get-all-idea", jwtUtility.authenticateAccessToken, StartupController.getAllIdea)
    app.get("/get-ideaof-user", jwtUtility.authenticateAccessToken, StartupController.getIdeasOfUserAdmin)
